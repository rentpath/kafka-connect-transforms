...
public class ListJoinTransform<R extends ConnectRecord<R>> implements Transformation<R> {
    private static final Logger log = LoggerFactory.getLogger(ListJoinTransform.class);

    private ListJoinTransformConfig config;
    ...
    public void configure(Map<String, ?> map) {
        this.config = new ListJoinTransformConfig(map);
    }
}
